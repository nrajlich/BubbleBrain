...
export default function Sidemenu() {
  return (
    ...
    <Menu
      ...
      itemListClassName="flex flex-col gap-3 font-akatab justify-center items-center"
      ...
      <a id="home" className="menu-item  hover:text-gray-400" href="/">Courses</a>
      <a id="about" className="menu-item   hover:text-gray-400" href="/about">My Learning</a>
      <a id="contact" className="menu-item   hover:text-gray-400" href="/contact">Instructor</a>
